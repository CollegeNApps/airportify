...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                ...
                actions: [
                  IconButton(
                      ...
                      icon: const Icon(Icons.notifications_outlined,
                          color: Colors.black)),
                  IconButton(
                      onPressed: () => Get.to(()=> ProfileScreen(name: user.username!)),
    ...
    //       body: Center(
    //           child: Text("Why bro?"
    //               "\nI learnt lorem ipsum from Sudeep anna bro"
    //               "\n He'll come and pop up bro"
    //               "\nWhy you back stabbing bro"
    //               "\n Ahn bro, Nan mai mele  nalak laksha sala ide bro"
    //               "\nIf you do like this bank manager will pop me off bro"
    //               "\n Kindly you don't do me bro",
    //
