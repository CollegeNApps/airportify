...
class History extends StatelessWidget {
  ...
  History({Key? key, required this.driverAccess, required this.history})
      : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text("Airline: ${h.airline} (${h.flightName})",
                            ...
                            Container(
                                ...
                                height: 20,
                                decoration: BoxDecoration(
                                    color: ctrl.flightStatusCodeColors[
                                        h.flightStatusCode!.toInt() - 1],
                                    borderRadius: BorderRadius.circular(4)),
                                child: Center(
                                  child: Text("${h.flightStatus}",
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text("Arrival Time: ${h.at}",
                                style: const TextStyle(
                                    color: Colors.black,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 12)),
                            Text("Gate No: ${h.gateNo}",
                                style: const TextStyle(
                                    color: Colors.black,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 12)),
      ...
      return Row(
        ...
        children: [
          ...
          buildAmountContainer(
              w, calculatePricing('Porter', h.carryBags!, h.suitcases!))
        ],
      );
    } else {
      return Row(
        ...
        children: [
          ...
          buildAmountContainer(
              w, calculatePricing('Porter', h.adults!, h.kids!))
        ],
      );
    }
  }
